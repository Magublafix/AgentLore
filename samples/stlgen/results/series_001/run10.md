...
| Field | Value |
|-------|-------|
| Date | 2026-07-07 19:01 |
| Model | unsloth/Qwen3.5-35B-A3B-GGUF:Q4_K_M |
| Lore search active | yes (63 concepts) |
...
E   assert False
E    +  where False = <trimesh.Trimesh(vertices.shape=(2963, 3), faces.shape=(5886, 3))>.is_watertight
...
tests/test_text2stl_cli.py::TestCharacterShapes::test_character_shapes_not_truncated
  /tmp/lore_stlgen_run10_c27x7lx5/tests/test_text2stl_cli.py:52: DeprecationWarning: DEPRECATED: replace `path.to_planar`->`path.to_2D), removal 1/1/2026
...
================== 2 failed, 12 passed, 2 warnings in 26.97s ===================
