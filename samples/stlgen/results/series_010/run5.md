...
E   assert False
E    +  where False = <trimesh.Trimesh(vertices.shape=(534, 3), faces.shape=(1220, 3))>.is_watertight
...
E   assert 0.2265218849572363 >= 0.25
...
tests/test_text2stl_cli.py::TestCharacterShapes::test_character_shapes_not_truncated
  /tmp/lore_stlgen_run5_tr854hcs/tests/test_text2stl_cli.py:52: DeprecationWarning: DEPRECATED: replace `path.to_planar`->`path.to_2D), removal 1/1/2026
...
================== 3 failed, 11 passed, 2 warnings in 20.54s ===================
