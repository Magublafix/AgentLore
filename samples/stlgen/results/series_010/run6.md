...
```
.py::TestInvocation::test_single_char PASSED      [  7%]
...
tests/test_text2stl_cli.py:270: in test_width_scales_with_char_count
    assert w5 > w1, (
E   AssertionError: 5-char mesh width (18.72) is not wider than 1-char mesh (19.41)
E   assert 18.720256805419922 > 19.41176414489746
...
tests/test_text2stl_cli.py::TestCharacterShapes::test_character_shapes_not_truncated
  /tmp/lore_stlgen_run6_vfmxghi6/tests/test_text2stl_cli.py:52: DeprecationWarning: DEPRECATED: replace `path.to_planar`->`path.to_2D), removal 1/1/2026
...
============= 2 failed, 12 passed, 2 warnings in 73.66s (0:01:13) ==============
