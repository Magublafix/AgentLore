...
E   stdout: 
E   stderr: Error creating mesh: No valid contours found
...
tests/test_text2stl_cli.py:29: in text2stl
    pytest.fail(
E   Failed: text2stl A -o /tmp/pytest-of-magublafix/pytest-3537/test_width_scales_with_char_co0/a.stl exited 1
E   stdout: 
E   stderr: Error creating mesh: No valid contours found
...
tests/test_text2stl_cli.py:29: in text2stl
    pytest.fail(
E   Failed: text2stl HELLO -o /tmp/pytest-of-magublafix/pytest-3537/test_cross_section_is_nonempty0/hello.stl exited 1
E   stdout: 
E   stderr: Error creating mesh: No valid contours found
...
tests/test_text2stl_cli.py:29: in text2stl
    pytest.fail(
E   Failed: text2stl HELLO -o /tmp/pytest-of-magublafix/pytest-3537/test_character_shapes_match_te0/hello.stl exited 1
E   stdout: 
E   stderr: Error creating mesh: No valid contours found
...
tests/test_text2stl_cli.py:29: in text2stl
    pytest.fail(
E   Failed: text2stl HELLO -o /tmp/pytest-of-magublafix/pytest-3537/test_character_shapes_not_trun0/hello.stl exited 1
E   stdout: 
E   stderr: Error creating mesh: No valid contours found
...
==================== 8 failed, 2 passed, 4 errors in 25.21s ====================
