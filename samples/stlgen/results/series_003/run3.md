...
tests/test_text2stl_cli.py:29: in text2stl
    pytest.fail(
E   Failed: text2stl A -o /tmp/pytest-of-magublafix/pytest-3527/test_width_scales_with_char_co0/a.stl exited 1
E   stdout: 
...
tests/test_text2stl_cli.py:29: in text2stl
    pytest.fail(
E   Failed: text2stl HELLO -o /tmp/pytest-of-magublafix/pytest-3527/test_cross_section_is_nonempty0/hello.stl exited 1
E   stdout: 
E   stderr: Error creating STL: The truth value of an array with more than one element is ambiguous. Use a.any() or a.all()
...
tests/test_text2stl_cli.py:29: in text2stl
    pytest.fail(
E   Failed: text2stl HELLO -o /tmp/pytest-of-magublafix/pytest-3527/test_character_shapes_match_te0/hello.stl exited 1
E   stdout: 
E   stderr: Error creating STL: The truth value of an array with more than one element is ambiguous. Use a.any() or a.all()
...
tests/test_text2stl_cli.py:29: in text2stl
    pytest.fail(
E   Failed: text2stl HELLO -o /tmp/pytest-of-magublafix/pytest-3527/test_character_shapes_not_trun0/hello.stl exited 1
E   stdout: 
E   stderr: Error creating STL: The truth value of an array with more than one element is ambiguous. Use a.any() or a.all()
...
==================== 8 failed, 2 passed, 4 errors in 23.52s ====================
