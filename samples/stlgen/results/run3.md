...
| Input tokens | 531,313 |
| Output tokens | 16,986 |
| Total tokens | 548,299 |
...
rootdir: /tmp/lore_stlgen_run3_2j46yqim
...
tests/test_text2stl_cli.py:234: in test_character_shapes_match_text
    assert iou >= 0.25, (
E   AssertionError: Character shape IoU 0.065 < 0.25 — cross-section does not resemble 'HELLO'. Letters may be malformed, missing, or in wrong order.
E   assert 0.06536453297234578 >= 0.25
=============================== warnings summary ===============================
tests/test_text2stl_cli.py::TestCharacterShapes::test_character_shapes_match_text
  /tmp/lore_stlgen_run3_2j46yqim/tests/test_text2stl_cli.py:52: DeprecationWarning: DEPRECATED: replace `path.to_planar`->`path.to_2D), removal 1/1/2026
...
=================== 2 failed, 11 passed, 1 warning in 23.56s ===================
